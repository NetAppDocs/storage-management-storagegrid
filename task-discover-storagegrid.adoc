...
Super admin, Storage admin, or System health specialist. link:https://docs.netapp.com/us-en/bluexp-setup-admin/reference-iam-predefined-roles.html[Learn about NetApp Console access roles.^]
...
+
https://docs.netapp.com/us-en/storagegrid/admin/using-storagegrid-security-certificates.html[Learn more about installing a management interface certificate on StorageGRID^]
...
.. In your on-premises StorageGRID system, follow the instructions: https://docs.netapp.com/us-en/storagegrid/admin/using-storagegrid-security-certificates.html[Installing a management interface certificate on StorageGRID^].
